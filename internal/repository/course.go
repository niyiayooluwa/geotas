...
func (r *CourseRepository) RemoveCourseMember(ctx context.Context, courseID pgtype.UUID, userID pgtype.UUID) error {
	return r.queries.RemoveCourseMember(ctx, db.RemoveCourseMemberParams{
		CourseID: courseID,
		UserID:   userID,
	})
}
